...
SENSORS = {
    ...
    "solid_ems_solid_grid_import_today": {
    ...
    "solid_ems_solid_battery_charge_today": {
    ...
    "solid_ems_solid_battery_discharge_today": {
    ...
    "solid_ems_solid_home_load_today": {
        "name": "Home Load Today",
        "key": "home_load_today_kwh",
        "unit": "kWh",
        "device_class": "energy",
        "state_class": "total",
        "icon": "mdi:home-lightning-bolt",
    },
    "solid_ems_solid_revenue_today": {
        "name": "Revenue Today",
        "key": "revenue_today_eur",
        "unit": "EUR",
        "device_class": "monetary",
        "state_class": "total",
        "icon": "mdi:cash-clock",
    },
    "solid_ems_solid_revenue_month": {
        "name": "Revenue Month",
        "key": "revenue_month_eur",
        "unit": "EUR",
        "device_class": "monetary",
        "state_class": "total",
        "icon": "mdi:cash-calendar",
    },
    "solid_ems_solid_revenue_year": {
        "name": "Revenue Year",
        "key": "revenue_year_eur",
        "unit": "EUR",
        "device_class": "monetary",
        "state_class": "total",
        "icon": "mdi:cash-multiple",
    },
    "solid_ems_solid_revenue_total": {
        "name": "Revenue Total",
        "key": "revenue_total_eur",
        "unit": "EUR",
        "device_class": "monetary",
        "state_class": "total",
